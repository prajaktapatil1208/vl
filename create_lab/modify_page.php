<?php
	...
	if (isset($_POST['update'])) {
		...
		$update_exp_details  = update_exp_details($exp_id,$lab,$intro,$theory,$obj,$path,$quiz);
		...
		if($update_exp_details == "success") {
			
			?>
			 <script>
				alert("Success");
			 </script><?php
			header( "refresh:1; url=modify_page.php" );
		}
		else
		{
			echo "failed";
				...
				<div class="main-content-inner">
						<div class="row">
							<div class="col-xs-12">
								...
								<br /><br />
								<form class="form-horizontal" role="form" action="modify_page.php" method="POST">
...
<script type="text/javascript">
	function show_list2()
	{
        ...
        xhttp.open("POST", "../config/ajax/add_page22.php", true);
        xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
...
<script type="text/javascript">
	function show_list3()
	{
        ...
        xhttp.open("POST", "../config/ajax/modify_page.php", true);
        xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
